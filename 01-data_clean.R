...
# Load bird data
tic()
birds <- read.delim("data/Bogotá/Birds/Bogotabirddata.txt") |> 
    janitor::clean_names() |> 
    as_tibble()
toc()
...
city <- st_read("data/Bogotá/Valor_ref_2023/Valor_ref_2023.shp") |>  # Polygons
    select(value = V_REF)
...
# para guardar, cambiar nombre por ciudad
bogota = dat
